  ...
  return (
    ...
    >
      <ScrollEffects>
        ...
        <ParallaxBanner
          imageUrl="/images/banner/servicesBanner.png"
        ...
        <section className="py-16 bg-gray-50 dark:bg-slate-900">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Medical Coding */}
              <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-lg scroll-slide-in delay-100">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  ...
                  coding requirements for various specialties, reducing errors
                  and speeding up claim processing.
                </p>
                ...
                <LinkTo
                  href="/contact-us"
                  passHref
                  className="inline-block bg-cyan-500 text-white px-6 py-2 rounded-md hover:bg-cyan-600 transition-colors"
                >
                  Learn More
                </LinkTo>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-lg scroll-slide-in delay-200">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  ...
                  existing EMR and practice management software. We can follow
                  your office policies and procedures and give you full control
                  on everything we do.
                </p>
                <ul className="text-gray-600 dark:text-gray-300 space-y-2 mb-6">
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-lg scroll-slide-in delay-300">
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-lg scroll-slide-in delay-400">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  ...
                  provide accurate and timely transcription of medical reports
                  to ensure clear documentation and efficient clinical
                  workflows.
                </p>
                <ul className="text-gray-600 dark:text-gray-300 space-y-2 mb-6">
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-lg scroll-slide-in delay-500">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Guiding you to compliance, performance, and incentives. Our
                  team of consultants helps clients get maximum incentives from
                  CMS programs using certified registries.
                </p>
                <ul className="text-gray-600 dark:text-gray-300 space-y-2 mb-6">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Exceptional customer service and patient support throughout
                  the process
                </p>
              </div>
        ...
        <section className="py-16 bg-white dark:bg-slate-800">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 scroll-fade-in">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Our certified coders have expertise across all medical
                specialties
              </p>
            </div>
        ...
        {/* CTA Section with Fixed Background and Scrolling Content */}
        <section
          className="py-24 text-white relative overflow-hidden cta-parallax-section"
          style={{
            backgroundImage: "url('/images/banner/billingSolution.png')",
        ...
        >
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="cta-content-animation">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 cta-title-animation">
                Customized Billing Solutions, Powered by Expertise
              </h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto cta-description-animation">
                Built for your success. With years of experience, we have
                developed future-ready solutions for healthcare providers
                nationwide.
              </p>
              <div className="flex justify-center gap-4 flex-wrap cta-buttons-animation">
                <LinkTo
                  href="/contact-us"
                  passHref
