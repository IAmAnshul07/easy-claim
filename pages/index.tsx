...
const Home = () => {
  return (
    <PageLayout home PAGE_SEO={DEFAULT_SEO}>
      {/* Hero Section */}
      <section
        className="w-full md:pt-[100px] md:pb-[70px] pt-[130px] pb-20 mb-10 text-white relative"
        style={{
          backgroundImage: "url(/images/banner/bannerImage.jpg)",
      ...
      >
        ...
        {/* Content */}
        <div className="container text-center px-3 relative z-10">
